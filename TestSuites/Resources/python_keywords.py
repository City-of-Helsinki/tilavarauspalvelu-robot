...
def get_finnish_day(date_time):
    ...
    # Return the abbreviated day of the week in Finnish (e.g., "Ma", "Ti")
    return date_time.strftime("%a").capitalize()
...
def convert_booking_time_to_ics(time_string):
    ...
    if not date_match:
        raise ValueError("Date format not found in input string.")
