...
${URL_PROD}                                             https://varaamo.hel.fi/
${URL_ADMIN}                                            https://varaamo.test.hel.ninja/kasittely
${URL_DJANGO_ADMIN}                                     https://varaamo.test.hel.ninja/admin/login/
...
${RESERVATION_BUSINESS}                                 id=reserveeType__COMPANY
